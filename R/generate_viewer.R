...
#'
#' Combines the Mermaid pipeline graph, verb-level before/after tables, and
#' node metadata into a single HTML file that works offline (except for the
#' Mermaid.js CDN request needed to render the graph).
#'
